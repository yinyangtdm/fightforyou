const links = [
  ...
  {name:"Alfredo Parrish",linkedin:"https://www.linkedin.com/company/parrish-kruidenier-law-firm"},
  ...
  {name:"Benjamin L. Crump",linkedin:"https://www.linkedin.com/company/ben-crump-law"},
  {name:"Ben Salango",linkedin:"https://www.linkedin.com/company/salango-law-pllc/"},
  ...
  {name:"Brewster & De Angelis, PLLC",linkedin:"https://www.linkedin.com/company/brewster-de-angelis-pllc"},
  ...
  {name:"Dan Stormer",linkedin:"https://www.linkedin.com/company/hadsell-stormer-renick-&-dai-llp"},
  {name:"David Rudovsky",linkedin:"https://www.linkedin.com/company/kairys-rudovsky-messing-feinberg-lin-llp"},
  {name:"Friedman Law Offices",linkedin:"https://www.linkedin.com/company/friedman-law-offices/about/"},
  ...
  {name:"Gingras, Thomsen & Wachs, LLP",linkedin:"https://www.linkedin.com/company/gingras-thomsen-&-wachs-llp"},
  ...
  {name:"Langrock Sperry & Wool, LLP",linkedin:"https://www.linkedin.com/company/langrock-sperry-&-wool"},
  ...
  {name:"Ringstrom DeKrey, PLLP",linkedin:"https://www.linkedin.com/company/ringstromdekrey"},
  {name:"Salvi, Schostok & Pritchard, P.C.",linkedin:"https://www.linkedin.com/in/patrick-salvi-6123bb6/"},
  {name:"Schonbrun Seplow Harris Hoffman & Zeldes, LLP",linkedin:"https://www.linkedin.com/company/schonbrun-seplow-harris-hoffman-zeldes"},
  ...
  {name:"The Simon Law Firm, PC",linkedin:"https://www.linkedin.com/company/the-simon-law-firm-p-c-/"},
...
async function run() {
  ...
  console.log("\n")
  results.forEach(r => {
    const flag = r.notFound ? "❌ BAD" : "  ok "
    console.log(`${flag}  [${r.status}]  ${r.name}`)
    if (r.notFound) console.log(`       ${r.url}\n       -> ${r.finalUrl}${r.err ? "\n       ERR: "+r.err : ""}`)
  })
}
run()
