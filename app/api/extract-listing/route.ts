...
- zipCode (string)
- isNational (boolean — true if the lawyer or firm explicitly serves clients nationwide or across the US rather than a specific state or region)
- specialties (array of strings — practice area names)
